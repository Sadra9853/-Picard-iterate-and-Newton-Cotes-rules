...
e=abs(L-xs);
M=max(e)
% save('C:\09127944942\amanuscript\Fractional\Volltera  one\Matlab\Example2\n=80\k=10\Voltteraexample.mat','e','M','it1','xs','L','n','k');
plot(I,e,'r*');
...
%Computing  Re-NCR n,r,q (K(t r ,·,x(·)),[t 0 = a,t r = a + rh])Iterative method based on 
